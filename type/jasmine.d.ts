...
declare function it(expectation: string, assertion?: (done: () => void) => void, time?:number): void;
...
declare function beforeEach(action: (done: () => void) => void, time: number): void;
declare function afterEach(action: () => void): void;
declare function afterEach(action: (done: () => void) => void): void;
declare function afterEach(action: (done: () => void) => void, time:number): void;
